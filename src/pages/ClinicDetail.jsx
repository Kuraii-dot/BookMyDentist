...
import { MapPin, Phone, Mail, Clock, ChevronLeft, Star } from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="card overflow-hidden mb-5">
          ...
          <div className="p-5">
            <div className="flex items-start gap-4">
              {/* Logo */}
              <div className="w-18 h-18 rounded-xl border-4 border-white shadow-md overflow-hidden -mt-12 shrink-0 bg-white w-16 h-16">
                {clinic.logo_url
        ...
        <div className="flex gap-1 card p-1 mb-5">
          {[{key:'services',label:`Services (${services.length})`},{key:'reviews',label:`Reviews (${reviews.length})`}].map(t=>(
