...
export default function ProfileEdit() {
  ...
  async function handleSendOtp() {
    ...
    if (!/^\+63\d{10}$/.test(formatted)) {
      toast.error('Enter a valid PH number first (09XX XXX XXXX)'); return
    }
  ...
  async function handleVerifyOtp() {
    ...
    const { error } = await supabase.auth.verifyOtp({ phone: formatted, token: otpCode.trim(), type: 'sms' })
          ...
          <form onSubmit={handleSaveProfile} className="space-y-5">
            ...
            <div>
              ...
              {phoneVerified
                ...
                : form.phone
                  ? <p className="text-amber-600 text-xs mt-1">⚠️ Not verified —{' '}
                      <button type="button" onClick={() => setTab('phone')} className="underline font-medium">verify in Phone tab</button>
                    </p>
        ...
        <div className="card p-6">
          {phoneVerified ? (
            <div className="text-center py-4">
              ...
              <p className="text-slate-400 text-xs mb-5">You will receive SMS alerts for bookings, reminders, and promos.</p>
              <div className="bg-sky-50 rounded-2xl p-4 text-left space-y-2">
                <p className="text-sky-700 text-xs font-semibold uppercase tracking-wide mb-2">SMS notifications include:</p>
            ...
            <div>
              <div className="mb-5">
                ...
                <p className="text-slate-500 text-sm">We will send a 6-digit code via SMS to confirm your number.</p>
              </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="text-center">
                    {countdown > 0
                      ...
                      : <button onClick={handleSendOtp} disabled={sendingOtp} className="text-sky-600 text-sm font-medium hover:text-sky-700">
                          🔄 Resend code
                        </button>
                    }
                  </div>
