      ...
      <div className="bg-white rounded-2xl border border-amber-100 p-6">
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative h-36 rounded-xl overflow-hidden bg-gradient-to-br from-amber-100 to-orange-100 border-2 border-dashed border-amber-200 flex items-center justify-center group cursor-pointer"
              onClick={() => document.getElementById('banner-input').click()}>
              {bannerUrl
                ? <img src={bannerUrl} alt="Banner" className="w-full h-full object-cover" />
                : <div className="text-center"><p className="text-2xl mb-1">🖼️</p><p className="text-amber-600 text-sm font-medium">Upload Banner</p><p className="text-stone-400 text-xs">Recommended: 1200×400px</p></div>
              }
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-20 h-20 rounded-2xl overflow-hidden bg-amber-100 border-2 border-dashed border-amber-200 flex items-center justify-center cursor-pointer group relative shrink-0"
              ...
              <div>
                ...
                <button type="button" onClick={() => document.getElementById('logo-input').click()}
                  className="mt-2 text-xs bg-amber-100 hover:bg-amber-200 text-amber-700 font-semibold px-3 py-1.5 rounded-lg transition-colors">
                  Upload Logo
                </button>
              </div>
            </div>
          ...
          <div>
            ...
            <textarea value={form.description} onChange={e => setForm({ ...form, description: e.target.value })}
              ...
              rows={3} className="w-full border border-amber-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-300 resize-none" />
          </div>
